...
x-complete: 0
info:
  title: SendGrid Add Whitelabel Links  Valate
  description: |-
...
paths:
  ...
  /whitelabel/links/{id}/validate:
    post:
      summary: Add Whitelabel Links  Valate
      description: |-
        **This endpoint allows you to validate a link whitelabel.**
        ...
        For more information, please see our [User Guide](https://sendgrid.com/docs/API_Reference/Web_API_v3/Whitelabel/links.html).
      operationId: whitelabel.links.id.validate.post
      x-api-path-slug: whitelabellinksidvalidate-post
      parameters:
      - in: body
        name: body
        schema:
